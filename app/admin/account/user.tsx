    ...
    <div>
      ...
      <div className="grid border-b py-4 sm:grid-cols-2">
        ...
        <div className="mt-2 sm:mt-0">
          <Input type="text" className="h-12" defaultValue="Brian" />
        </div>
      </div>
      <div className="grid border-b py-4 sm:grid-cols-2">
        <div className="text-base font-medium text-[#666d80]">Email</div>
        <div className="mt-2 sm:mt-0">
          <Input type="text" className="h-12" defaultValue="alesik@mail.com" />
        </div>
      </div>
      <div className="grid border-b py-4 sm:grid-cols-2">
        ...
        <div className="mt-2 w-full sm:mt-0">
          <Space.Compact className="flex">
            <Select defaultValue="1" className="h-12" options={phone_options} />
            <Input defaultValue="(684) 550-0012" className="h-12" />
          </Space.Compact>
        </div>
      </div>
