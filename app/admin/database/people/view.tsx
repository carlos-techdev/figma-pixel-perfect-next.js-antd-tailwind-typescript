  ...
  return (
    <div className="space-y-3 pl-4 pr-1 pt-0">
      ...
      <div className="flex w-[112px] items-center justify-between">
        <div className="text-[14px] font-bold leading-[21px]">Work History</div>
        <MyIcon type="caret" className="rotate-0" />
      </div>
      <div className="flex w-[112px] items-center">
        <div className="text-[14px] font-bold leading-[21px]">Skills</div>
        <MyIcon type="caret" className="rotate-0" />
      </div>
    </div>
  )
